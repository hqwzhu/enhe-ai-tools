...
export default function DecryptedText({
  ...
  const triggerHoverDecrypt = useCallback(() => {
    ...
    setDirection("forward");
    setIsAnimating(true);
  }, [isAnimating, shouldReduceMotion, text]);
  ...
  useEffect(() => {
    if (shouldReduceMotion || (animateOn !== "view" && animateOn !== "inViewHover")) return;
  ...
  useEffect(() => {
    ...
    setRevealedIndices(new Set());
    setDirection("forward");
  }, [animateOn, text, encryptInstantly, resetToPlainText, shouldReduceMotion]);
