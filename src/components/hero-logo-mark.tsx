  ...
  return (
    ...
    >
      <svg className="enhe-hero-logo-svg" viewBox="0 0 640 420" role="img" aria-hidden="true">
        <defs>
          <linearGradient id="heroBlueFill" x1="116" y1="70" x2="420" y2="338" gradientUnits="userSpaceOnUse">
            <stop stopColor="#082FE6" />
            <stop offset="0.56" stopColor="#075CFF" />
            <stop offset="1" stopColor="#18BDE8" />
          </linearGradient>
          <linearGradient id="heroBlueEdge" x1="112" y1="46" x2="434" y2="352" gradientUnits="userSpaceOnUse">
            <stop stopColor="#7AA7FF" />
            <stop offset="0.5" stopColor="#0BE7FF" />
            <stop offset="1" stopColor="#48F5D3" />
          </linearGradient>
          <linearGradient id="heroMetalFill" x1="398" y1="68" x2="548" y2="350" gradientUnits="userSpaceOnUse">
            <stop stopColor="#566170" />
            <stop offset="0.18" stopColor="#1C2630" />
            <stop offset="0.62" stopColor="#08111B" />
          ...
          <filter id="heroLogoGlow" x="-18%" y="-26%" width="136%" height="152%">
            ...
            <feColorMatrix
              in="blur"
              type="matrix"
              values="0 0 0 0 0.102 0 0 0 0 0.698 0 0 0 0 1 0 0 0 0.7 0"
            />
            <feBlend in="SourceGraphic" mode="screen" />
          </filter>
          <filter id="heroMetalShadow" x="-12%" y="-14%" width="124%" height="128%">
            <feDropShadow dx="0" dy="14" stdDeviation="13" floodColor="#020713" floodOpacity="0.5" />
            <feDropShadow dx="0" dy="0" stdDeviation="5" floodColor="#48F5D3" floodOpacity="0.22" />
          </filter>
        </defs>
        <g className="enhe-logo-part enhe-logo-slat-top" filter="url(#heroLogoGlow)">
          ...
          <path d="M125 116L172 79H411" stroke="#B9F7FF" strokeWidth="3" strokeLinecap="round" opacity="0.58" />
          <path d="M114 130H420" stroke="#022C8E" strokeWidth="7" opacity="0.58" />
        </g>
        <g className="enhe-logo-part enhe-logo-slat-mid" filter="url(#heroLogoGlow)">
          ...
          <path d="M120 190H354" stroke="#B9F7FF" strokeWidth="3" strokeLinecap="round" opacity="0.5" />
          <path d="M112 235H360" stroke="#022C8E" strokeWidth="7" opacity="0.55" />
        </g>
        <g className="enhe-logo-part enhe-logo-slat-bottom" filter="url(#heroLogoGlow)">
          ...
          <path d="M125 294H411" stroke="#B9F7FF" strokeWidth="3" strokeLinecap="round" opacity="0.46" />
          <path d="M168 354H420" stroke="#022C8E" strokeWidth="7" opacity="0.55" />
        </g>
        <g className="enhe-logo-part enhe-logo-metal" filter="url(#heroMetalShadow)">
          ...
          <path d="M412 191H490V85L500 74H539" stroke="#B9F7FF" strokeWidth="3" strokeLinecap="round" opacity="0.34" />
          <path d="M495 334H538V78" stroke="#6D7785" strokeWidth="8" opacity="0.42" />
        </g>
