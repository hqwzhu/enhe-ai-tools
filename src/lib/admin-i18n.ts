...
export const adminDictionaries = {
  zh: {
    ...
    dashboard: {
      ...
      remindersTitle: "运营提醒",
      toolMix: "工具结构：{software} 个本地应用，{online} 个云端工具。文件上传、COS 异常和售后事项可在文件管理、消息中心和售后/退款中集中处理。",
      popularTools: "热门工具",
  ...
  en: {
    ...
    dashboard: {
      ...
      toolMix: "Tool mix: {software} desktop apps and {online} web tools. File uploads, COS issues, and after-sales tasks are handled from Files, Messages, and Refund review.",
