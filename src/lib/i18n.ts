...
export const dictionaries = {
  zh: {
    ...
    home: {
      ...
      featuredContentEmpty: "推荐工具将在后台设置后显示在这里。",
    ...
    listing: {
      ...
      softwareIntro: "下载 AI 软件应用，子分类由后台自定义维护。",
      onlineTitle: "AI账号服务",
      onlineIntro: "浏览 AI 账号服务，了解服务内容、价格和交付说明。",
      skillLearningTitle: "AI技能学习",
      skillLearningIntro: "购买 AI 技能课程，解锁图文教程和实战指南。",
  ...
  en: {
    ...
    home: {
      ...
      metricsTools: "Featured tools and courses",
      ...
      featuredContentEmpty: "Recommended tools will appear here after they are configured in the admin panel.",
      featuredSoftwareEyebrow: "AI Software Apps",
