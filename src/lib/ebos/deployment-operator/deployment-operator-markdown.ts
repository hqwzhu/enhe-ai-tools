...
export function renderDeploymentCommandAuditMarkdown(audit: EbosDeploymentCommandAudit) {
  return [
    ...
    `- migrationCommandRequiresExplicitApproval: ${audit.migrationCommandRequiresExplicitApproval ?? true}`,
...
export function renderDeploymentOperatorChecklistMarkdown(report: EbosDeploymentOperatorChecklistReport) {
  return [
    ...
    `- migrationCommandRequiresExplicitApproval: ${report.commandAudit.migrationCommandRequiresExplicitApproval ?? true}`,
