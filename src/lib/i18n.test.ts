...
describe("homepage and navigation copy", () => {
  it("uses the new Chinese themed product-entry naming", () => {
    ...
    expect(dictionaries.zh.home.softwareButton).toBe("提升工作效率");
    ...
    expect(dictionaries.zh.listing.softwareTitle).toBe("提升工作效率");
  ...
  it("uses matching English naming for the same surfaces", () => {
    ...
    expect(dictionaries.en.home.softwareButton).toBe("Boost Productivity");
