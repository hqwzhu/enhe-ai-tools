...
export const dictionaries = {
  zh: {
    ...
    listing: {
      ...
      skillLearningTitle: "改变你未来的AI工具/技能",
      skillLearningIntro: "按 AI 智能体、生活实用AI工具、智能体、账号订购、升级订阅、AI 提示词和 AI 副业变现分类查找产品，把 AI 从工具变成长期机会。",
  ...
  en: {
    ...
    listing: {
      ...
      skillLearningTitle: "AI Tools and Skills for Your Future",
      skillLearningIntro: "Find AI agents, everyday AI tools, account subscriptions, upgrade plans, AI prompts, and AI side-income products.",
