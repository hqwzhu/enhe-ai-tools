...
describe("site header brand source", () => {
  it("uses the approved night logo asset, points the logo to the homepage, and keeps language controls after user center", () => {
    ...
    expect(component).toContain('<Link href="/" className="site-brand group"');
