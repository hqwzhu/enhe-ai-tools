...
function SoftwareGeoBlock({ forceLocale }: { forceLocale: Locale }) {
  ...
  const links = [
    { label: { zh: "学习 AI 技能教程", en: "Learn AI skill courses" }, href: buildLocalePath("/skill-learning", forceLocale) },
    { label: { zh: "查看 AI 前沿资讯", en: "Read AI news" }, href: buildLocalePath("/ai-news", forceLocale) },
    { label: { zh: "了解 AI 账号服务", en: "Review account services" }, href: buildLocalePath("/account-services", forceLocale) }
  ];
