...
const developmentCopy = {
  ...
  en: {
    ...
    module: "Module",
    modulePlaceholder: "Orders / Payment / VIP",
...
const developmentTranslations: Record<string, string> = {
  ...
  "VIP 与订单": "VIP and orders",
  "会员套餐管理": "VIP plan management",
  "后台可维护套餐，前台可创建会员订单。": "Admins can maintain plans and users can create membership orders.",
  ...
  "审核通过统一调用 membership 服务，VIP 与软件购买权益分流处理。": "Approval calls the membership service and separates VIP benefits from software purchase rights.",
  "权限控制": "Access control",
  "VIP 软件下载权限": "VIP software download access",
  ...
  "站内通知": "Notifications",
  "支付审核、退款处理、VIP 调整已通知用户。": "Payment review, refund handling, and VIP adjustments notify users.",
  ...
  "已集中展示待审核付款、退款申请、上传异常和 VIP 到期提醒。": "Pending payments, refund requests, upload issues, and VIP expiry reminders are centralized.",
