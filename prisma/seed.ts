...
async function main() {
  ...
  const defaults = [
    ...
    ["home_hero_intro", "让每一个普通人，都能轻松用好 AI，把想法变成作品，把效率变成价值。", "首页介绍文案"],
    ["home_hero_subtitle_en", "Master AI intelligence and reshape your life", "首页英文副标题"],
    ["home_hero_intro_en", "Helping everyone use AI with confidence—turn ideas into creations and productivity into value.", "首页英文介绍文案"],
